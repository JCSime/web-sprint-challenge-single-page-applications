...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
        useRouteMatch allows to construct nested paths with access to objects it finds.
        
1. How would you explain form validation to someone who has never programmed before?
        It's a wat to make sure you get the right data from users and not unusable data.

1. In 1-2 sentences, define end to end testing.
        End to end testing is when you test your application from first to last line of code. Testing the entire application.
